...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Vendor - Edit</h1>
    </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="collapse show" id="companyDetails">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter latitude" name="latitude" id="latitude" value="<?php if(set_value('latitude')){ echo set_value('latitude'); }elseif(isset($company['latitude'])){ echo $company['latitude']; } ?>">
                                <?php echo form_error('latitude'); ?>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter longitude" name="longitude" id="longitude" value="<?php if(set_value('longitude')){ echo set_value('longitude'); }elseif(isset($company['longitude'])){ echo $company['longitude']; } ?>">
                            ...
                            <div class="form-group">
                                <a target="_blank" href="<?php echo base_url('uploads/gst/'.$company['gst_doc']); ?>">View GST document</a>
                            </div>
                            <?php endif; ?>
                            <div class="form-group">
                                <label>PAN No</label>
                            ...
                            <div class="form-group">
                                <a target="_blank" href="<?php echo base_url('uploads/pan/'.$company['pan_doc']); ?>">View PAN document</a>
                            </div>
                            <?php endif; ?>
                            <div class="form-group">
                                <label>TIN No</label>
                            ...
                            <div class="form-group">
                                <a target="_blank" href="<?php echo base_url('uploads/tin/'.$company['tin_doc']); ?>">View TIN document</a>
                            </div>
                            <?php endif; ?>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <a target="_blank" href="<?php echo base_url('uploads/service_tax/'.$company['service_tax_doc']); ?>">View Service tax document</a>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
