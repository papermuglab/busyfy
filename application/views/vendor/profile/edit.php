...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        Account status - <?php echo getAccountStatusName($vendor['status']); ?>
        <?php if($vendor['status'] != '1'): ?><br>CA Comment - <?php echo $company['comment']; ?>.<?php endif; ?>
    </div>
    <?php echo $this->session->flashdata('message'); ?>
    <form id="joinVendor" action="<?php echo base_url('vendor/profile/save'); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="collapse show" id="companyDetails">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>GST No</label><span class=""> (<?php echo $company['gst_verified'] == '1' ? 'Verified' : 'Not Verified'; ?>)</span>
                                ...
                                <?php if ($company['gst_verified'] != '1'): ?>
                                <span class="error"><?php echo $company['gst_comment']; ?></span>
                                <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <div class="form-group">
                                <label>PAN No</label><span class=""> (<?php echo $company['pan_verified'] == '1' ? 'Verified' : 'Not Verified'; ?>)</span>
                                ...
                                <?php if ($company['pan_verified'] != '1'): ?>
                                <span class="error"><?php echo $company['pan_comment']; ?></span>
                                <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <div class="form-group">
                                <label>TIN No</label><span class=""> (<?php echo $company['tin_verified'] == '1' ? 'Verified' : 'Not Verified'; ?>)</span>
                                ...
                                <?php if ($company['tin_verified'] != '1'): ?>
                                <span class="error"><?php echo $company['tin_comment']; ?></span>
                                <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <div class="form-group">
                                <label>Service tax ID</label><span class=""> (<?php echo $company['service_tax_id_verified'] == '1' ? 'Verified' : 'Not Verified'; ?>)</span>
                                ...
                                <?php if ($company['service_tax_id_verified'] != '1'): ?>
                                <span class="error"><?php echo $company['service_tax_id_comment']; ?></span>
                                <?php endif; ?>
