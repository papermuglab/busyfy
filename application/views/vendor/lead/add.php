                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="product_id" id="product_id" required="required">
                                    ...
                                    <option value="<?php echo $row['id']; ?>" <?php if(set_value('product_id')){ if(set_value('product_id') == $row['id']){ echo 'selected'; } } ?> <?php if(isset($lead)){ if($lead['product_id'] == $row['id']){ echo 'selected'; } } ?>><?php echo $row['name']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="assigned_to" id="staff_id" required="required">
                                    ...
                                    <option value="<?php echo $row['id']; ?>" <?php if(set_value('assigned_to')){ if(set_value('assigned_to') == $row['id']){ echo 'selected'; } } ?> <?php if(isset($lead)){ if($lead['assigned_to'] == $row['id']){ echo 'selected'; } } ?>><?php echo $row['name']; ?></option>
                                    <?php endforeach; endif; ?>
                                </select>
