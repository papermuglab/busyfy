    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <form>
                    <input type="hidden" name="url" id="url" value="<?php echo base_url('vendor/staff/index/'); ?>">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-2">
                            ...
                            <a class="btn btn-secondary" href="<?php echo base_url('vendor/staff/index/'); ?>">Reset</a>
                        </div>
                    </div>
                </form>
                    ...
                    <tbody>
                        <?php foreach ($staffs AS $staff): ?>
                            <tr id="row_<?php echo $staff['staff_id']; ?>">
                                ...
                                <td>
                                    <a href="<?php echo base_url('vendor/staff/edit/' . encrypt($staff['staff_id'])); ?>" class="btn btn-primary btn-circle btn-sm"><i class="fas fa-eye"></i></a>
