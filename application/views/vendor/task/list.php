    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <form>
                    <input type="hidden" name="url" id="url" value="<?php echo base_url('vendor/task/index/'); ?>">
                    <div class="row">
                        <div class="col-md-5">
                        ...
                        <div class="col-md-2">
                            ...
                            <a class="btn btn-secondary" href="<?php echo base_url('vendor/task/index/'); ?>">Reset</a>
                        </div>
                    </div>
                </form>
                    ...
                    <tbody>
                        <?php foreach ($tasks AS $task): ?>
                            <tr id="row_<?php echo $task['task_id']; ?>">
                                ...
                                <td>
                                    <a title="Edit" href="<?php echo base_url('vendor/task/edit/' . encrypt($task['task_id'])); ?>" class="btn btn-primary btn-circle btn-sm"><i class="fas fa-eye"></i></a>
                                    <a title="Track Task" href="<?php echo base_url('vendor/task/track/' . encrypt($task['task_id'])); ?>" class="btn btn-primary btn-circle btn-sm"><i class="fas fa-eye"></i></a>
